...
TileMap<TMapData>::TileMap(ResourceManager& resourceManager) :
...
template<class TMapData>
bool TileMap<TMapData>::load(const std::string& mapName)
{
...
template<class TMapData>
bool TileMap<TMapData>::loadFromFile(const std::string& mapName)
{
...
template<class TMapData>
bool TileMap<TMapData>::loadFromMemory(TileMapData& data)
{
	m_data = &data;
    return true;
}
...
template<class TMapData>
void TileMap<TMapData>::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
